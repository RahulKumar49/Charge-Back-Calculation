            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div>
                            	<h4 class="nav navbar-nav navbar-left">Add Transaction</h4>
                            </div><br>
          
                            <form action="/ChargeBack/customer/capturePayment" method="post" modelAttribute="payment" >
							  <div class="form-group">
							    <label class="col-sm-2 col-form-label">A/c No.</label>
							    <div class="col-sm-10">
							      <input type="number" class="form-control" name="accountNumber" placeholder="Account Number" value="${accountNumber}" readonly >
							    </div>
							  </div>
							  <div class="form-group">
							  ...
							  <div class="form-group">
							    <label class="col-sm-2 col-form-label">Dispute</label>
							      <div class="col-sm-10">
							       <select name="dispute" id="dispute" class="form-control dispute" onchange='CheckColors(this.value);' required>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							       <select name="reason" id="reason" class="form-control reason" onchange='CheckColors(this.value);'  required disabled>
							       <option value="" disabled selected>Select your option</option>
							  ...
							  <div class="form-group" >
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" name="remarks" id="remarks" placeholder="Remarks" disabled/>
							    </div>
							  </div>
							  <div class="form-group">
							    <div class="col-sm-12">
...
<script type="text/javascript">
    ...
    $("select.reason").change(function(){
        var remark = $(this).children("option:selected").val();
        if(remark=="Other")
        {
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
    $("select.dispute").change(function(){
