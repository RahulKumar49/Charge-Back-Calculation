...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <!-- <li>
                    <a href="customer/cbDetails"  class="ml-4 mt-2"><button type="button" class="btn btn-info btn-block">ChargeBack Details</button></a>
                </li>  -->
            </ul>
    	</div>
    </div>
    ...
    <div class="main-panel">
        <nav class="navbar navbar-inverse navbar-sticky-top-fixed" style="
    position: relative;
    top: -20px;
    overflow: hidden;
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                        <div>
                            	<h4 class="nav navbar-nav navbar-left">Refund Chargeback</h4>
                            </div><br>
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped">
									  ...
									  <tbody>
									  	...
									  	<tr>
									      <th scope="row">${transaction.t_id}</th>
							  ...
							  <form action="customer/changeStatus" class="form-group" modelAttribute="refundDetails" method="post" >
							       <span hidden> transcationId:<input type="text" name="t_id" value="${transaction.t_id}" hidden ><br></span>
							        <label >Refund amount:</label>
							        <input type="number" class="form-control" name="refundAmount"  value="${transaction.amount}" readonly>
							        <br>
							        <label>Refund Status:</label>
							        <select name="refundStatus" class="form-control" required>
							  <option value=1>Accept</option>
							  <option value=2>Reject</option>
							  </select>
							  <br>
							 Comments:<textarea rows="5" class="form-control" name="comments" placeholder="Comments"></textarea>
							<br>
