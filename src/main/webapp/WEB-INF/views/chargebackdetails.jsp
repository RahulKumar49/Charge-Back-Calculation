            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                        <div>
                            	<h4 class="nav navbar-nav navbar-left">Chargeback</h4>
                            </div><br>
                            ...
                            <c:if test="${list==1 }">
								<table class="table table-hover table-striped">
								  ...
								  <tbody>
								  <c:forEach var="temp" items="${cbDetails}">
								   ...
								   <%--  <c:url var="productsLink" value="/vendor/vendorproduct">
								    ...
								    <tr>
								      ...
								      <td>${temp.address}</td>
								      <td>${temp.contact}</td>
								      <td><a href="customer/cbTransactions?id=${temp.accountNumber}"><button type="button" class="btn btn-primary">View</button></a></td>
								    </tr>
								  </c:forEach>
								  </tbody> 
